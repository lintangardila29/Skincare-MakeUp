...
return [
    ...
    */
    ...
    |
    */
    "description" => env("SWAGGER_DESCRIPTION", "Documentation for API"),
    ...
    |
    */
    "email" => env("SWAGGER_EMAIL", "lintangardila@gmail.com"),
